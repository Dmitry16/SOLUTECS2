...
export class WebCompleta extends React.Component {
  ...
  render() {
    ...
    return (
      <WrapperMax1100 style={{margin:'15% auto 5%'}}>
        <H1>Sitio Web Completo</H1>
        <H3 style={{margin:'5%'}}>Te desarrollamos un sitio web que va a incluir los siguientes elementos y servicios :</H3>
        <ol>
          <li>
